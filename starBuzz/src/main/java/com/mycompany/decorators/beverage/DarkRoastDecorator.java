...
/**
 * Decorador concreto que representa una bebida de tipo "Dark Roast". Extiende
 * la clase base `BaseBeverageDecorator` y añade el costo y el mensaje
 * específico para la bebida "Dark Roast".
 *
 * @author Eduardo Talavera Ramos | 00000245244 | Fecha: 08/09/2024
 */
public class DarkRoastDecorator extends BaseBeverageDecorator {

    private final float costo = 45.00f; // Costo específico para la bebida "Dark Roast".

    /**
     * Constructor que recibe una instancia de IBeverage (bebida base) y la
     * envuelve con el decorador "Dark Roast".
     *
     * @param wrapped La bebida base que será decorada con Dark Roast.
     */
    ...
    /**
     * Método que imprime la adición de "Dark Roast" a la bebida junto con su
    ...
    public void send(String msg) {
        msg = "* Dark Roast .......... "; // Modifica el mensaje para incluir "Dark Roast".
